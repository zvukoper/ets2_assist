...
**ШАГ №0 — СТАРТ (до ВСЕХ анализов/оценок/работы над запросом и файлами):**
1. Прочитать `MemoryAI\ollama_parsed_usage.txt` (строка 1 = процент с запятой, строка 2 =
   время до ресета). Это делается ПЕРВЫМ, до любых других действий.
...
**ШАГ №1.5 — ОСТАНОВКА И ОЖИДАНИЕ КОМАНДЫ ПОЛЬЗОВАТЕЛЯ (03.09.2026):**
...
**ДАЛЬНЕЙШИЕ ШАГИ:** идёт работа над задачами.
...
## Список задач (TODO)
- [x] **SDO (Static Data Objects) — РЕАЛИЗОВАНО И ПРОВЕРЕНО (03.09.2026, v39.26-SDO-NAME-ICON-FONT):**
