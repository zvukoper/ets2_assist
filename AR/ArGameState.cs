...
namespace ETS2_Assist_GUI.AR
{
    ...
    public sealed class ArGameState
    {
        ...
        // v1.0.40.31: оставлено ТОЛЬКО для обратной совместимости — реальной
        // землёй считается GroundPlane (плоскость по колёсам), см. ниже.
        public double GroundY;

        // ================================================================
        // v1.0.40.31: РЕАЛЬНАЯ ПЛОСКОСТЬ ДОРОГИ ПО КОЛЁСАМ (ArGroundPlane).
        // Единый источник геометрии земли для: сетки AR, создания новой точки
        // (луч × плоскость), дистанции до земли, отладочной визуализации высот.
        // null — плоскость не построена (нет данных колёс / меньше 3 колёс на земле).
        // ================================================================
        ...
        // v1.0.40.31: в геометрии AR1 БОЛЬШЕ НЕ ИСПОЛЬЗУЕТСЯ (PlaneOffsetM заменён
        // реальной плоскостью); сохранён для legacy-инструментов AR2.
