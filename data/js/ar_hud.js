...
(function () {
    ...
    const SMOOTH = {
        ...
        // уменьшает максимальный рывок. tau подобран 0.035: даёт минимум
        // дрожания при умеренной задержке (lag = v·tau ≈ 0.7 м при 20 м/с).
        posTau: 0.035,     // постоянная времени позиции, с
        rotTau: 0.040,     // ориентация — чуть мягче
