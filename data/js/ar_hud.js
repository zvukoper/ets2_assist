...
(function () {
    ...
    const SMOOTH = {
        ...
        //
        // Восстановлено рабочее состояние v1.0.40.44 до появления квестового
        // слоя: позиция 35 мс, ориентация 40 мс. C# при подключении присылает
        // актуальную настройку, но этот fallback тоже должен быть рабочим.
        posTau: 0.035,
        rotTau: 0.040,
